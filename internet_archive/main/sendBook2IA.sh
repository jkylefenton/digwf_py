...
--header 'x-archive-meta-sponsor:Emory University, Robert W. Woodruff Library' \
--header 'x-archive-meta-contributor:Emory University, Robert W. Woodruff Library' \
...
echo zip -r /temp/${1}_${2}_images.zip /mnt/lsdi2/${1}-${2}/${1}/Output/Images/JP2/*.jp2

# need to echo command to console
zip -r /temp/${1}_${2}_images.zip /mnt/lsdi2/${1}-${2}/${1}/Output/Images/JP2/*.jp2
