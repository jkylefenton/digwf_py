...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Record.oclc_trimmed'
        db.alter_column('repo_checker_record', 'oclc_trimmed', self.gf('django.db.models.fields.CharField')(max_length=11, null=True))


    def backwards(self, orm):
        
        # Changing field 'Record.oclc_trimmed'
        db.alter_column('repo_checker_record', 'oclc_trimmed', self.gf('django.db.models.fields.CharField')(default='', max_length=11))
