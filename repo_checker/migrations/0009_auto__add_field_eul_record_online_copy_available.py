...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Eul_Record.online_copy_available'
        db.add_column('repo_checker_eul_record', 'online_copy_available', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Eul_Record.online_copy_available'
        db.delete_column('repo_checker_eul_record', 'online_copy_available')
