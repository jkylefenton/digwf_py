...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Record.oclc_trimmed'
        db.add_column('repo_checker_record', 'oclc_trimmed', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=11, blank=True), keep_default=False)

        # Changing field 'Record.library'
        db.alter_column('repo_checker_record', 'library', self.gf('django.db.models.fields.CharField')(max_length=9))


    def backwards(self, orm):
        
        # Deleting field 'Record.oclc_trimmed'
        db.delete_column('repo_checker_record', 'oclc_trimmed')

        # Changing field 'Record.library'
        db.alter_column('repo_checker_record', 'library', self.gf('django.db.models.fields.CharField')(max_length=7))
    ...
    models = {
        ...
        'repo_checker.record': {
            ...
            'oclc_trimmed': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '11', 'blank': 'True'}),
