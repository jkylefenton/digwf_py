...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Eul_Record.digitization_proposal'
        db.add_column('repo_checker_eul_record', 'digitization_proposal', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Eul_Record.digitization_proposal'
        db.delete_column('repo_checker_eul_record', 'digitization_proposal')
