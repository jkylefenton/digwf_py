...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Eul_Record.pagination'
        db.add_column('repo_checker_eul_record', 'pagination', self.gf('django.db.models.fields.IntegerField')(db_index=True, max_length=4, null=True, blank=True), keep_default=False)

        # Adding field 'Eul_Record.height_cm'
        db.add_column('repo_checker_eul_record', 'height_cm', self.gf('django.db.models.fields.IntegerField')(db_index=True, max_length=2, null=True, blank=True), keep_default=False)

        # Adding field 'Eul_Record.width_cm'
        db.add_column('repo_checker_eul_record', 'width_cm', self.gf('django.db.models.fields.IntegerField')(db_index=True, max_length=2, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Eul_Record.pagination'
        db.delete_column('repo_checker_eul_record', 'pagination')

        # Deleting field 'Eul_Record.height_cm'
        db.delete_column('repo_checker_eul_record', 'height_cm')

        # Deleting field 'Eul_Record.width_cm'
        db.delete_column('repo_checker_eul_record', 'width_cm')
