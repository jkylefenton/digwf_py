...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Eul_Record.ff_lang'
        db.add_column('repo_checker_eul_record', 'ff_lang', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=3, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Eul_Record.ff_lang'
        db.delete_column('repo_checker_eul_record', 'ff_lang')
