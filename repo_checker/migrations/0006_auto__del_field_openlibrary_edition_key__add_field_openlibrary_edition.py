...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('repo_checker_openlibrary_edition', 'ol_key', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=25, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'OpenLibrary_Edition.key'
        db.add_column('repo_checker_openlibrary_edition', 'key', self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=25, db_index=True), keep_default=False)
