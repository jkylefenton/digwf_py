...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OpenLibrary_Edition.ol_key'
        db.delete_column('repo_checker_openlibrary_edition', 'ol_key')

        # Adding field 'OpenLibrary_Edition.key'
        db.add_column('repo_checker_openlibrary_edition', 'key', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=25, blank=True), keep_default=False)

        # Changing field 'OpenLibrary_Edition.lccn'
        db.alter_column('repo_checker_openlibrary_edition', 'lccn', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'OpenLibrary_Edition.isbn_13'
        db.alter_column('repo_checker_openlibrary_edition', 'isbn_13', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'OpenLibrary_Edition.isbn_10'
        db.alter_column('repo_checker_openlibrary_edition', 'isbn_10', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'OpenLibrary_Edition.oclc'
        db.alter_column('repo_checker_openlibrary_edition', 'oclc', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Adding field 'OpenLibrary_Edition.ol_key'
        db.add_column('repo_checker_openlibrary_edition', 'ol_key', self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=25, db_index=True), keep_default=False)

        # Deleting field 'OpenLibrary_Edition.key'
        db.delete_column('repo_checker_openlibrary_edition', 'key')

        # Changing field 'OpenLibrary_Edition.lccn'
        db.alter_column('repo_checker_openlibrary_edition', 'lccn', self.gf('django.db.models.fields.CharField')(max_length=12))

        # Changing field 'OpenLibrary_Edition.isbn_13'
        db.alter_column('repo_checker_openlibrary_edition', 'isbn_13', self.gf('django.db.models.fields.CharField')(max_length=13, null=True))

        # Changing field 'OpenLibrary_Edition.isbn_10'
        db.alter_column('repo_checker_openlibrary_edition', 'isbn_10', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'OpenLibrary_Edition.oclc'
        db.alter_column('repo_checker_openlibrary_edition', 'oclc', self.gf('django.db.models.fields.CharField')(max_length=16))
    ...
    models = {
        ...
        'repo_checker.openlibrary_edition': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '25', 'blank': 'True'}),
