...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OpenLibrary_Edition'
        db.create_table('repo_checker_openlibrary_edition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ol_key', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=25, blank=True)),
            ('isbn_13', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=13, null=True, blank=True)),
            ('isbn_10', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True)),
            ...
            ('publisher', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, blank=True)),
            ('lccn', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=12, blank=True)),
            ('publish_date', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=90, blank=True)),
        ))
        db.send_create_signal('repo_checker', ['OpenLibrary_Edition'])


    def backwards(self, orm):
        
        # Deleting model 'OpenLibrary_Edition'
        db.delete_table('repo_checker_openlibrary_edition')
    ...
    models = {
        ...
        'repo_checker.openlibrary_edition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isbn_10': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'isbn_13': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '13', 'null': 'True', 'blank': 'True'}),
            'lccn': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '12', 'blank': 'True'}),
            'oclc': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '16', 'blank': 'True'}),
