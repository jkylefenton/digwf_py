...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Eul_Record.wikipedia_referring_url'
        db.add_column('repo_checker_eul_record', 'wikipedia_referring_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Eul_Record.wikipedia_referring_url'
        db.delete_column('repo_checker_eul_record', 'wikipedia_referring_url')
    ...
    models = {
        'repo_checker.eul_record': {
            ...
            'wikipedia_referring_url': ('django.db.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'})
        },
