...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Eul_Record.ht_url'
        db.add_column('repo_checker_eul_record', 'ht_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Eul_Record.ia_url'
        db.add_column('repo_checker_eul_record', 'ia_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Eul_Record.ht_url'
        db.delete_column('repo_checker_eul_record', 'ht_url')

        # Deleting field 'Eul_Record.ia_url'
        db.delete_column('repo_checker_eul_record', 'ia_url')
    ...
    models = {
        'repo_checker.eul_record': {
            ...
            'ht_url': ('django.db.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'}),
            'ia_url': ('django.db.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'}),
