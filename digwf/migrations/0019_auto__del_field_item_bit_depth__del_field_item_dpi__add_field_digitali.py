...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Item.bit_depth'
        db.delete_column('digwf_item', 'bit_depth')

        # Deleting field 'Item.dpi'
        db.delete_column('digwf_item', 'dpi')

        # Adding field 'DigitalItem.dpi'
        db.add_column('digwf_digitalitem', 'dpi', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'DigitalItem.bit_depth'
        db.add_column('digwf_digitalitem', 'bit_depth', self.gf('django.db.models.fields.CharField')(default='8', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Item.bit_depth'
        db.add_column('digwf_item', 'bit_depth', self.gf('django.db.models.fields.CharField')(default='8', max_length=2), keep_default=False)

        # Adding field 'Item.dpi'
        db.add_column('digwf_item', 'dpi', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'DigitalItem.dpi'
        db.delete_column('digwf_digitalitem', 'dpi')

        # Deleting field 'DigitalItem.bit_depth'
        db.delete_column('digwf_digitalitem', 'bit_depth')
