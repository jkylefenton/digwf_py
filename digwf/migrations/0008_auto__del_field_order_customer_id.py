...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('digwf_order', 'customer_id_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Order.customer_id'
        raise RuntimeError("Cannot reverse this migration. 'Order.customer_id' and its values cannot be restored.")
