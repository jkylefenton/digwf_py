...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Item.item_title'
        db.delete_column('digwf_item', 'item_title')

        # Adding field 'Item.title'
        db.add_column('digwf_item', 'title', self.gf('django.db.models.fields.CharField')(default='Add title', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Item.item_title'
        raise RuntimeError("Cannot reverse this migration. 'Item.item_title' and its values cannot be restored.")

        # Deleting field 'Item.title'
        db.delete_column('digwf_item', 'title')
