...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Resource_Type.broad_type'
        db.delete_column('digwf_resource_type', 'broad_type')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Resource_Type.broad_type'
        raise RuntimeError("Cannot reverse this migration. 'Resource_Type.broad_type' and its values cannot be restored.")
