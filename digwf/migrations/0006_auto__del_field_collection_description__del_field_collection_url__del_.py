...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('digwf_collection', 'description')

        # Deleting field 'Collection.url'
        db.delete_column('digwf_collection', 'url')

        # Deleting field 'Collection.coll_id'
        db.delete_column('digwf_collection', 'coll_id')

        # Deleting field 'Collection.type'
        db.delete_column('digwf_collection', 'type')

        # Adding field 'Collection.collection_short_name'
        db.add_column('digwf_collection', 'collection_short_name', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)

        # Adding field 'Collection.collection_description'
        db.add_column('digwf_collection', 'collection_description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Collection.collection_url'
        db.add_column('digwf_collection', 'collection_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Collection.parent_collection'
        db.add_column('digwf_collection', 'parent_collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digwf.Collection'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Collection.description'
        raise RuntimeError("Cannot reverse this migration. 'Collection.description' and its values cannot be restored.")

        # Adding field 'Collection.url'
        db.add_column('digwf_collection', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Collection.coll_id'
        raise RuntimeError("Cannot reverse this migration. 'Collection.coll_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Collection.type'
        raise RuntimeError("Cannot reverse this migration. 'Collection.type' and its values cannot be restored.")

        # Deleting field 'Collection.collection_short_name'
        db.delete_column('digwf_collection', 'collection_short_name')

        # Deleting field 'Collection.collection_description'
        db.delete_column('digwf_collection', 'collection_description')

        # Deleting field 'Collection.collection_url'
        db.delete_column('digwf_collection', 'collection_url')

        # Deleting field 'Collection.parent_collection'
        db.delete_column('digwf_collection', 'parent_collection_id')
