...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Item.isbn'
        db.delete_column('digwf_item', 'isbn')

        # Deleting field 'Item.barcode'
        db.delete_column('digwf_item', 'barcode')

        # Deleting field 'Item.pid'
        db.delete_column('digwf_item', 'pid')

        # Deleting field 'Item.oclc'
        db.delete_column('digwf_item', 'oclc')

        # Deleting field 'Item.call_no'
        db.delete_column('digwf_item', 'call_no')

        # Deleting field 'Item.digital_masters_id'
        db.delete_column('digwf_item', 'digital_masters_id')

        # Deleting field 'Item.lccn'
        db.delete_column('digwf_item', 'lccn')

        # Deleting field 'Item.issn'
        db.delete_column('digwf_item', 'issn')

        # Deleting field 'Item.other_id'
        db.delete_column('digwf_item', 'other_id')


    def backwards(self, orm):
        
        # Adding field 'Item.isbn'
        db.add_column('digwf_item', 'isbn', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Item.barcode'
        db.add_column('digwf_item', 'barcode', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'Item.pid'
        db.add_column('digwf_item', 'pid', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'Item.oclc'
        db.add_column('digwf_item', 'oclc', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Item.call_no'
        db.add_column('digwf_item', 'call_no', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Item.digital_masters_id'
        db.add_column('digwf_item', 'digital_masters_id', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True, blank=True), keep_default=False)

        # Adding field 'Item.lccn'
        db.add_column('digwf_item', 'lccn', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Item.issn'
        db.add_column('digwf_item', 'issn', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Item.other_id'
        db.add_column('digwf_item', 'other_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)
