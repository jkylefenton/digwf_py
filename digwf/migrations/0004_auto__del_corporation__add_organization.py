...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('digwf_organization', (
            ...
            ('organization_short_name', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
    ...
    models = {
        ...
        'digwf.organization': {
            ...
            'organization_short_name': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'})
        },
        'digwf.person': {
