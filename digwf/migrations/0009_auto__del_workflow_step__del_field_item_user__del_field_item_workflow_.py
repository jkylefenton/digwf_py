...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('digwf_item', 'user')

        # Deleting field 'Item.workflow_step'
        db.delete_column('digwf_item', 'workflow_step_id')

        # Changing field 'Item.isbn'
        db.alter_column('digwf_item', 'isbn', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Item.pid'
        db.alter_column('digwf_item', 'pid', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Item.oclc'
        db.alter_column('digwf_item', 'oclc', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Item.other_id'
        db.alter_column('digwf_item', 'other_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Item.barcode'
        db.alter_column('digwf_item', 'barcode', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Item.digital_masters_id'
        db.alter_column('digwf_item', 'digital_masters_id', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True))

        # Changing field 'Item.issn'
        db.alter_column('digwf_item', 'issn', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Item.lccn'
        db.alter_column('digwf_item', 'lccn', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Order.date_order_due'
        db.alter_column('digwf_order', 'date_order_due', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Item.user'
        raise RuntimeError("Cannot reverse this migration. 'Item.user' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Item.workflow_step'
        raise RuntimeError("Cannot reverse this migration. 'Item.workflow_step' and its values cannot be restored.")

        # Changing field 'Item.isbn'
        db.alter_column('digwf_item', 'isbn', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Item.pid'
        db.alter_column('digwf_item', 'pid', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Item.oclc'
        db.alter_column('digwf_item', 'oclc', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Item.other_id'
        db.alter_column('digwf_item', 'other_id', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Item.barcode'
        db.alter_column('digwf_item', 'barcode', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # User chose to not deal with backwards NULL issues for 'Item.digital_masters_id'
        raise RuntimeError("Cannot reverse this migration. 'Item.digital_masters_id' and its values cannot be restored.")

        # Changing field 'Item.issn'
        db.alter_column('digwf_item', 'issn', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Item.lccn'
        db.alter_column('digwf_item', 'lccn', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # User chose to not deal with backwards NULL issues for 'Order.date_order_due'
        raise RuntimeError("Cannot reverse this migration. 'Order.date_order_due' and its values cannot be restored.")
