...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.time_spent'
        db.alter_column('digwf_item', 'time_spent', self.gf('django.db.models.fields.TimeField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Item.time_spent'
        raise RuntimeError("Cannot reverse this migration. 'Item.time_spent' and its values cannot be restored.")
