...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agent.phone'
        db.alter_column('digwf_agent', 'phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'Agent.state'
        db.alter_column('digwf_agent', 'state', self.gf('django.contrib.localflavor.us.models.USStateField')(max_length=2))


    def backwards(self, orm):
        
        # Changing field 'Agent.phone'
        db.alter_column('digwf_agent', 'phone', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'Agent.state'
        db.alter_column('digwf_agent', 'state', self.gf('django.db.models.fields.CharField')(max_length=2))
