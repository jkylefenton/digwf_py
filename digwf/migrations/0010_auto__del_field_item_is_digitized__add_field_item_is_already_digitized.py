...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Item.is_digitized'
        db.delete_column('digwf_item', 'is_digitized')

        # Adding field 'Item.is_already_digitized'
        db.add_column('digwf_item', 'is_already_digitized', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Item.has_rights'
        db.alter_column('digwf_item', 'has_rights_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digwf.Rights'], null=True))

        # Changing field 'Item.pub_state'
        db.alter_column('digwf_item', 'pub_state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digwf.Publication_State'], null=True))


    def backwards(self, orm):
        
        # Adding field 'Item.is_digitized'
        db.add_column('digwf_item', 'is_digitized', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Item.is_already_digitized'
        db.delete_column('digwf_item', 'is_already_digitized')

        # User chose to not deal with backwards NULL issues for 'Item.has_rights'
        raise RuntimeError("Cannot reverse this migration. 'Item.has_rights' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Item.pub_state'
        raise RuntimeError("Cannot reverse this migration. 'Item.pub_state' and its values cannot be restored.")
