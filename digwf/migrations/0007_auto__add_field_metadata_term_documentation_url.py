...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Metadata_Term.documentation_url'
        db.add_column('digwf_metadata_term', 'documentation_url', self.gf('django.db.models.fields.URLField')(max_length=2083, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Metadata_Term.documentation_url'
        db.delete_column('digwf_metadata_term', 'documentation_url')
